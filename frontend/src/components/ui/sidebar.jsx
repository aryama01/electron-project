...
// Sidebar context shape (no TS types in JS)
            ...
            <div
                className={cn(
                    ...
                    variant === "floating" || variant === "inset"
                        ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width)_+_theme(spacing.4))]"
...
const SidebarMenu = React.forwardRef((props, ref) => {
    const { className, ...rest } = props;
    return <ul ref={ref} data-sidebar="menu" className={cn("flex w-full min-w-0 flex-col gap-1", className)} {...rest} />;
});
SidebarMenu.displayName = "SidebarMenu";

const SidebarMenuItem = React.forwardRef((props, ref) => {
    const { className, ...rest } = props;
    return <li ref={ref} data-sidebar="menu-item" className={cn("group/menu-item relative", className)} {...rest} />;
});
